...
class DeclarationNode {
	...
	public String toString() {
		String result = "{\n";
		result += "  " + NodePrintHelper.quote("String") + ": " + NodePrintHelper.quote(inducedBy.getQualifiedName()) + ",\n";
		result += "  " + NodePrintHelper.quote("Formal") + ": " + NodePrintHelper.toJsonLikeArray(formalArguments);

 ...
 */
public class CloneVisitor extends spoon9.reflect.visitor.CtScanner {
	private final spoon9.support.visitor.equals.CloneHelper cloneHelper;

	private final CloneBuilder builder = new CloneBuilder();

	private spoon9.reflect.declaration.CtElement other;

	public CloneVisitor(spoon9.support.visitor.equals.CloneHelper cloneHelper) {
		this.cloneHelper = cloneHelper;
	}

	public <T extends spoon9.reflect.declaration.CtElement> T getClone() {
		return ((T) (other));
	}
	...
	public <A extends java.lang.annotation.Annotation> void visitCtAnnotation(final spoon9.reflect.declaration.CtAnnotation<A> annotation) {
		spoon9.reflect.declaration.CtAnnotation<A> aCtAnnotation = annotation.getFactory().Core().createAnnotation();
	...
	public <A extends java.lang.annotation.Annotation> void visitCtAnnotationType(final spoon9.reflect.declaration.CtAnnotationType<A> annotationType) {
		spoon9.reflect.declaration.CtAnnotationType<A> aCtAnnotationType = annotationType.getFactory().Core().createAnnotationType();
	...
	public void visitCtAnonymousExecutable(final spoon9.reflect.declaration.CtAnonymousExecutable anonymousExec) {
		spoon9.reflect.declaration.CtAnonymousExecutable aCtAnonymousExecutable = anonymousExec.getFactory().Core().createAnonymousExecutable();
	...
	public <T> void visitCtArrayRead(final spoon9.reflect.code.CtArrayRead<T> arrayRead) {
		spoon9.reflect.code.CtArrayRead<T> aCtArrayRead = arrayRead.getFactory().Core().createArrayRead();
	...
	public <T> void visitCtArrayWrite(final spoon9.reflect.code.CtArrayWrite<T> arrayWrite) {
		spoon9.reflect.code.CtArrayWrite<T> aCtArrayWrite = arrayWrite.getFactory().Core().createArrayWrite();
	...
	public <T> void visitCtArrayTypeReference(final spoon9.reflect.reference.CtArrayTypeReference<T> reference) {
		spoon9.reflect.reference.CtArrayTypeReference<T> aCtArrayTypeReference = reference.getFactory().Core().createArrayTypeReference();
	...
	public <T> void visitCtAssert(final spoon9.reflect.code.CtAssert<T> asserted) {
		spoon9.reflect.code.CtAssert<T> aCtAssert = asserted.getFactory().Core().createAssert();
	...
	public <T, A extends T> void visitCtAssignment(final spoon9.reflect.code.CtAssignment<T, A> assignement) {
		spoon9.reflect.code.CtAssignment<T, A> aCtAssignment = assignement.getFactory().Core().createAssignment();
	...
	public <T> void visitCtBinaryOperator(final spoon9.reflect.code.CtBinaryOperator<T> operator) {
		spoon9.reflect.code.CtBinaryOperator<T> aCtBinaryOperator = operator.getFactory().Core().createBinaryOperator();
	...
	public <R> void visitCtBlock(final spoon9.reflect.code.CtBlock<R> block) {
		spoon9.reflect.code.CtBlock<R> aCtBlock = block.getFactory().Core().createBlock();
	...
	public void visitCtBreak(final spoon9.reflect.code.CtBreak breakStatement) {
		spoon9.reflect.code.CtBreak aCtBreak = breakStatement.getFactory().Core().createBreak();
	...
	public <S> void visitCtCase(final spoon9.reflect.code.CtCase<S> caseStatement) {
		spoon9.reflect.code.CtCase<S> aCtCase = caseStatement.getFactory().Core().createCase();
	...
	public void visitCtCatch(final spoon9.reflect.code.CtCatch catchBlock) {
		spoon9.reflect.code.CtCatch aCtCatch = catchBlock.getFactory().Core().createCatch();
	...
	public <T> void visitCtClass(final spoon9.reflect.declaration.CtClass<T> ctClass) {
		spoon9.reflect.declaration.CtClass<T> aCtClass = ctClass.getFactory().Core().createClass();
	...
	public void visitCtTypeParameter(spoon9.reflect.declaration.CtTypeParameter typeParameter) {
		spoon9.reflect.declaration.CtTypeParameter aCtTypeParameter = typeParameter.getFactory().Core().createTypeParameter();
	...
	public <T> void visitCtConditional(final spoon9.reflect.code.CtConditional<T> conditional) {
		spoon9.reflect.code.CtConditional<T> aCtConditional = conditional.getFactory().Core().createConditional();
	...
	public <T> void visitCtConstructor(final spoon9.reflect.declaration.CtConstructor<T> c) {
		spoon9.reflect.declaration.CtConstructor<T> aCtConstructor = c.getFactory().Core().createConstructor();
	...
	public void visitCtContinue(final spoon9.reflect.code.CtContinue continueStatement) {
		spoon9.reflect.code.CtContinue aCtContinue = continueStatement.getFactory().Core().createContinue();
	...
	public void visitCtDo(final spoon9.reflect.code.CtDo doLoop) {
		spoon9.reflect.code.CtDo aCtDo = doLoop.getFactory().Core().createDo();
	...
	public <T extends Enum<?>> void visitCtEnum(final spoon9.reflect.declaration.CtEnum<T> ctEnum) {
		spoon9.reflect.declaration.CtEnum<T> aCtEnum = ctEnum.getFactory().Core().createEnum();
	...
	public <T> void visitCtExecutableReference(final spoon9.reflect.reference.CtExecutableReference<T> reference) {
		spoon9.reflect.reference.CtExecutableReference<T> aCtExecutableReference = reference.getFactory().Core().createExecutableReference();
	...
	public <T> void visitCtField(final spoon9.reflect.declaration.CtField<T> f) {
		spoon9.reflect.declaration.CtField<T> aCtField = f.getFactory().Core().createField();
	...
	public <T> void visitCtEnumValue(final spoon9.reflect.declaration.CtEnumValue<T> enumValue) {
		spoon9.reflect.declaration.CtEnumValue<T> aCtEnumValue = enumValue.getFactory().Core().createEnumValue();
	...
	public <T> void visitCtThisAccess(final spoon9.reflect.code.CtThisAccess<T> thisAccess) {
		spoon9.reflect.code.CtThisAccess<T> aCtThisAccess = thisAccess.getFactory().Core().createThisAccess();
	...
	public <T> void visitCtAnnotationFieldAccess(final spoon9.reflect.code.CtAnnotationFieldAccess<T> annotationFieldAccess) {
		spoon9.reflect.code.CtAnnotationFieldAccess<T> aCtAnnotationFieldAccess = annotationFieldAccess.getFactory().Core().createAnnotationFieldAccess();
	...
	public <T> void visitCtFieldReference(final spoon9.reflect.reference.CtFieldReference<T> reference) {
		spoon9.reflect.reference.CtFieldReference<T> aCtFieldReference = reference.getFactory().Core().createFieldReference();
	...
	public void visitCtFor(final spoon9.reflect.code.CtFor forLoop) {
		spoon9.reflect.code.CtFor aCtFor = forLoop.getFactory().Core().createFor();
	...
	public void visitCtForEach(final spoon9.reflect.code.CtForEach foreach) {
		spoon9.reflect.code.CtForEach aCtForEach = foreach.getFactory().Core().createForEach();
	...
	public void visitCtIf(final spoon9.reflect.code.CtIf ifElement) {
		spoon9.reflect.code.CtIf aCtIf = ifElement.getFactory().Core().createIf();
		...
		aCtIf.setThenStatement(this.cloneHelper.clone(((spoon9.reflect.code.CtStatement) (ifElement.getThenStatement()))));
		aCtIf.setElseStatement(this.cloneHelper.clone(((spoon9.reflect.code.CtStatement) (ifElement.getElseStatement()))));
	...
	public <T> void visitCtInterface(final spoon9.reflect.declaration.CtInterface<T> intrface) {
		spoon9.reflect.declaration.CtInterface<T> aCtInterface = intrface.getFactory().Core().createInterface();
	...
	public <T> void visitCtInvocation(final spoon9.reflect.code.CtInvocation<T> invocation) {
		spoon9.reflect.code.CtInvocation<T> aCtInvocation = invocation.getFactory().Core().createInvocation();
	...
	public <T> void visitCtLiteral(final spoon9.reflect.code.CtLiteral<T> literal) {
		spoon9.reflect.code.CtLiteral<T> aCtLiteral = literal.getFactory().Core().createLiteral();
	...
	public void visitCtTextBlock(final spoon9.reflect.code.CtTextBlock literal) {
		spoon9.reflect.code.CtTextBlock aCtTextBlock = literal.getFactory().Core().createTextBlock();
	...
	public <T> void visitCtLocalVariable(final spoon9.reflect.code.CtLocalVariable<T> localVariable) {
		spoon9.reflect.code.CtLocalVariable<T> aCtLocalVariable = localVariable.getFactory().Core().createLocalVariable();
	...
	public <T> void visitCtLocalVariableReference(final spoon9.reflect.reference.CtLocalVariableReference<T> reference) {
		spoon9.reflect.reference.CtLocalVariableReference<T> aCtLocalVariableReference = reference.getFactory().Core().createLocalVariableReference();
	...
	public <T> void visitCtCatchVariable(final spoon9.reflect.code.CtCatchVariable<T> catchVariable) {
		spoon9.reflect.code.CtCatchVariable<T> aCtCatchVariable = catchVariable.getFactory().Core().createCatchVariable();
	...
	public <T> void visitCtCatchVariableReference(final spoon9.reflect.reference.CtCatchVariableReference<T> reference) {
		spoon9.reflect.reference.CtCatchVariableReference<T> aCtCatchVariableReference = reference.getFactory().Core().createCatchVariableReference();
	...
	public <T> void visitCtMethod(final spoon9.reflect.declaration.CtMethod<T> m) {
		spoon9.reflect.declaration.CtMethod<T> aCtMethod = m.getFactory().Core().createMethod();
	...
	public <T> void visitCtAnnotationMethod(spoon9.reflect.declaration.CtAnnotationMethod<T> annotationMethod) {
		spoon9.reflect.declaration.CtAnnotationMethod<T> aCtAnnotationMethod = annotationMethod.getFactory().Core().createAnnotationMethod();
	...
	public <T> void visitCtNewArray(final spoon9.reflect.code.CtNewArray<T> newArray) {
		spoon9.reflect.code.CtNewArray<T> aCtNewArray = newArray.getFactory().Core().createNewArray();
	...
	public <T> void visitCtConstructorCall(final spoon9.reflect.code.CtConstructorCall<T> ctConstructorCall) {
		spoon9.reflect.code.CtConstructorCall<T> aCtConstructorCall = ctConstructorCall.getFactory().Core().createConstructorCall();
	...
	public <T> void visitCtNewClass(final spoon9.reflect.code.CtNewClass<T> newClass) {
		spoon9.reflect.code.CtNewClass<T> aCtNewClass = newClass.getFactory().Core().createNewClass();
	...
	public <T> void visitCtLambda(final spoon9.reflect.code.CtLambda<T> lambda) {
		spoon9.reflect.code.CtLambda<T> aCtLambda = lambda.getFactory().Core().createLambda();
	...
	public <T, E extends spoon9.reflect.code.CtExpression<?>> void visitCtExecutableReferenceExpression(final spoon9.reflect.code.CtExecutableReferenceExpression<T, E> expression) {
		spoon9.reflect.code.CtExecutableReferenceExpression<T, E> aCtExecutableReferenceExpression = expression.getFactory().Core().createExecutableReferenceExpression();
	...
	public <T, A extends T> void visitCtOperatorAssignment(final spoon9.reflect.code.CtOperatorAssignment<T, A> assignment) {
		spoon9.reflect.code.CtOperatorAssignment<T, A> aCtOperatorAssignment = assignment.getFactory().Core().createOperatorAssignment();
	...
	public void visitCtPackage(final spoon9.reflect.declaration.CtPackage ctPackage) {
		spoon9.reflect.declaration.CtPackage aCtPackage = ctPackage.getFactory().Core().createPackage();
	...
	public void visitCtPackageReference(final spoon9.reflect.reference.CtPackageReference reference) {
		spoon9.reflect.reference.CtPackageReference aCtPackageReference = reference.getFactory().Core().createPackageReference();
	...
	public <T> void visitCtParameter(final spoon9.reflect.declaration.CtParameter<T> parameter) {
		spoon9.reflect.declaration.CtParameter<T> aCtParameter = parameter.getFactory().Core().createParameter();
	...
	public <T> void visitCtParameterReference(final spoon9.reflect.reference.CtParameterReference<T> reference) {
		spoon9.reflect.reference.CtParameterReference<T> aCtParameterReference = reference.getFactory().Core().createParameterReference();
	...
	public <R> void visitCtReturn(final spoon9.reflect.code.CtReturn<R> returnStatement) {
		spoon9.reflect.code.CtReturn<R> aCtReturn = returnStatement.getFactory().Core().createReturn();
	...
	public <R> void visitCtStatementList(final spoon9.reflect.code.CtStatementList statements) {
		spoon9.reflect.code.CtStatementList aCtStatementList = statements.getFactory().Core().createStatementList();
	...
	public <S> void visitCtSwitch(final spoon9.reflect.code.CtSwitch<S> switchStatement) {
		spoon9.reflect.code.CtSwitch<S> aCtSwitch = switchStatement.getFactory().Core().createSwitch();
	...
	public <T, S> void visitCtSwitchExpression(final spoon9.reflect.code.CtSwitchExpression<T, S> switchExpression) {
		spoon9.reflect.code.CtSwitchExpression<T, S> aCtSwitchExpression = switchExpression.getFactory().Core().createSwitchExpression();
	...
	public void visitCtSynchronized(final spoon9.reflect.code.CtSynchronized synchro) {
		spoon9.reflect.code.CtSynchronized aCtSynchronized = synchro.getFactory().Core().createSynchronized();
	...
	public void visitCtThrow(final spoon9.reflect.code.CtThrow throwStatement) {
		spoon9.reflect.code.CtThrow aCtThrow = throwStatement.getFactory().Core().createThrow();
	...
	public void visitCtTry(final spoon9.reflect.code.CtTry tryBlock) {
		spoon9.reflect.code.CtTry aCtTry = tryBlock.getFactory().Core().createTry();
	...
	public void visitCtTryWithResource(final spoon9.reflect.code.CtTryWithResource tryWithResource) {
		spoon9.reflect.code.CtTryWithResource aCtTryWithResource = tryWithResource.getFactory().Core().createTryWithResource();
	...
	public void visitCtTypeParameterReference(final spoon9.reflect.reference.CtTypeParameterReference ref) {
		spoon9.reflect.reference.CtTypeParameterReference aCtTypeParameterReference = ref.getFactory().Core().createTypeParameterReference();
	...
	public void visitCtWildcardReference(spoon9.reflect.reference.CtWildcardReference wildcardReference) {
		spoon9.reflect.reference.CtWildcardReference aCtWildcardReference = wildcardReference.getFactory().Core().createWildcardReference();
	...
	public <T> void visitCtIntersectionTypeReference(final spoon9.reflect.reference.CtIntersectionTypeReference<T> reference) {
		spoon9.reflect.reference.CtIntersectionTypeReference<T> aCtIntersectionTypeReference = reference.getFactory().Core().createIntersectionTypeReference();
	...
	public <T> void visitCtTypeReference(final spoon9.reflect.reference.CtTypeReference<T> reference) {
		spoon9.reflect.reference.CtTypeReference<T> aCtTypeReference = reference.getFactory().Core().createTypeReference();
	...
	public <T> void visitCtTypeAccess(final spoon9.reflect.code.CtTypeAccess<T> typeAccess) {
		spoon9.reflect.code.CtTypeAccess<T> aCtTypeAccess = typeAccess.getFactory().Core().createTypeAccess();
	...
	public <T> void visitCtUnaryOperator(final spoon9.reflect.code.CtUnaryOperator<T> operator) {
		spoon9.reflect.code.CtUnaryOperator<T> aCtUnaryOperator = operator.getFactory().Core().createUnaryOperator();
	...
	public <T> void visitCtVariableRead(final spoon9.reflect.code.CtVariableRead<T> variableRead) {
		spoon9.reflect.code.CtVariableRead<T> aCtVariableRead = variableRead.getFactory().Core().createVariableRead();
	...
	public <T> void visitCtVariableWrite(final spoon9.reflect.code.CtVariableWrite<T> variableWrite) {
		spoon9.reflect.code.CtVariableWrite<T> aCtVariableWrite = variableWrite.getFactory().Core().createVariableWrite();
	...
	public void visitCtWhile(final spoon9.reflect.code.CtWhile whileLoop) {
		spoon9.reflect.code.CtWhile aCtWhile = whileLoop.getFactory().Core().createWhile();
	...
	public <T> void visitCtCodeSnippetExpression(final spoon9.reflect.code.CtCodeSnippetExpression<T> expression) {
		spoon9.reflect.code.CtCodeSnippetExpression<T> aCtCodeSnippetExpression = expression.getFactory().Core().createCodeSnippetExpression();
	...
	public void visitCtCodeSnippetStatement(final spoon9.reflect.code.CtCodeSnippetStatement statement) {
		spoon9.reflect.code.CtCodeSnippetStatement aCtCodeSnippetStatement = statement.getFactory().Core().createCodeSnippetStatement();
	...
	public <T> void visitCtUnboundVariableReference(final spoon9.reflect.reference.CtUnboundVariableReference<T> reference) {
		spoon9.reflect.reference.CtUnboundVariableReference<T> aCtUnboundVariableReference = reference.getFactory().Core().createUnboundVariableReference();
	...
	public <T> void visitCtFieldRead(final spoon9.reflect.code.CtFieldRead<T> fieldRead) {
		spoon9.reflect.code.CtFieldRead<T> aCtFieldRead = fieldRead.getFactory().Core().createFieldRead();
	...
	public <T> void visitCtFieldWrite(final spoon9.reflect.code.CtFieldWrite<T> fieldWrite) {
		spoon9.reflect.code.CtFieldWrite<T> aCtFieldWrite = fieldWrite.getFactory().Core().createFieldWrite();
	...
	public <T> void visitCtSuperAccess(final spoon9.reflect.code.CtSuperAccess<T> f) {
		spoon9.reflect.code.CtSuperAccess<T> aCtSuperAccess = f.getFactory().Core().createSuperAccess();
	...
	public void visitCtComment(final spoon9.reflect.code.CtComment comment) {
		spoon9.reflect.code.CtComment aCtComment = comment.getFactory().Core().createComment();
	...
	public void visitCtJavaDoc(final spoon9.reflect.code.CtJavaDoc javaDoc) {
		spoon9.reflect.code.CtJavaDoc aCtJavaDoc = javaDoc.getFactory().Core().createJavaDoc();
	...
	public void visitCtJavaDocTag(final spoon9.reflect.code.CtJavaDocTag docTag) {
		spoon9.reflect.code.CtJavaDocTag aCtJavaDocTag = docTag.getFactory().Core().createJavaDocTag();
	...
	public void visitCtImport(final spoon9.reflect.declaration.CtImport ctImport) {
		spoon9.reflect.declaration.CtImport aCtImport = ctImport.getFactory().Core().createImport();
	...
	public void visitCtModule(spoon9.reflect.declaration.CtModule module) {
		spoon9.reflect.declaration.CtModule aCtModule = module.getFactory().Core().createModule();
	...
	public void visitCtModuleReference(spoon9.reflect.reference.CtModuleReference moduleReference) {
		spoon9.reflect.reference.CtModuleReference aCtModuleReference = moduleReference.getFactory().Core().createModuleReference();
	...
	public void visitCtPackageExport(spoon9.reflect.declaration.CtPackageExport moduleExport) {
		spoon9.reflect.declaration.CtPackageExport aCtPackageExport = moduleExport.getFactory().Core().createPackageExport();
	...
	public void visitCtModuleRequirement(spoon9.reflect.declaration.CtModuleRequirement moduleRequirement) {
		spoon9.reflect.declaration.CtModuleRequirement aCtModuleRequirement = moduleRequirement.getFactory().Core().createModuleRequirement();
	...
	public void visitCtProvidedService(spoon9.reflect.declaration.CtProvidedService moduleProvidedService) {
		spoon9.reflect.declaration.CtProvidedService aCtProvidedService = moduleProvidedService.getFactory().Core().createProvidedService();
	...
	public void visitCtUsedService(spoon9.reflect.declaration.CtUsedService usedService) {
		spoon9.reflect.declaration.CtUsedService aCtUsedService = usedService.getFactory().Core().createUsedService();
	...
	public void visitCtCompilationUnit(spoon9.reflect.declaration.CtCompilationUnit compilationUnit) {
		spoon9.reflect.declaration.CtCompilationUnit aCtCompilationUnit = compilationUnit.getFactory().Core().createCompilationUnit();
	...
	public void visitCtPackageDeclaration(spoon9.reflect.declaration.CtPackageDeclaration packageDeclaration) {
		spoon9.reflect.declaration.CtPackageDeclaration aCtPackageDeclaration = packageDeclaration.getFactory().Core().createPackageDeclaration();
	...
	public void visitCtTypeMemberWildcardImportReference(spoon9.reflect.reference.CtTypeMemberWildcardImportReference wildcardReference) {
		spoon9.reflect.reference.CtTypeMemberWildcardImportReference aCtTypeMemberWildcardImportReference = wildcardReference.getFactory().Core().createTypeMemberWildcardImportReference();
	...
	public void visitCtYieldStatement(spoon9.reflect.code.CtYieldStatement statement) {
		spoon9.reflect.code.CtYieldStatement aCtYieldStatement = statement.getFactory().Core().createYieldStatement();

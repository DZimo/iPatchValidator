...
public class CloneVisitor extends CtScanner {
	...
	public void visitCtTextBlock(final CtTextBlock literal) {
		CtTextBlock aCtTextBlock = literal.getFactory().Core().createTextBlock();
	...
	public <T, S> void visitCtSwitchExpression(final CtSwitchExpression<T, S> switchExpression) {
		CtSwitchExpression<T, S> aCtSwitchExpression = switchExpression.getFactory().Core().createSwitchExpression();
	...
	public void visitCtTypeMemberWildcardImportReference(CtTypeMemberWildcardImportReference wildcardReference) {
		CtTypeMemberWildcardImportReference aCtTypeMemberWildcardImportReference = wildcardReference.getFactory().Core().createTypeMemberWildcardImportReference();
	...
	public void visitCtYieldStatement(CtYieldStatement statement) {
		CtYieldStatement aCtYieldStatement = statement.getFactory().Core().createYieldStatement();

...
public class ReplacementVisitor extends CtScanner {
	...
	class CtYieldStatementExpressionReplaceListener implements ReplaceListener<CtExpression> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtTypeMemberWildcardImportReferenceTypeReferenceReplaceListener implements ReplaceListener<CtTypeReference> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtPackageDeclarationReferenceReplaceListener implements ReplaceListener<CtPackageReference> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtCompilationUnitDeclaredTypeReferencesReplaceListener implements ReplaceListListener<List> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtCompilationUnitDeclaredModuleReferenceReplaceListener implements ReplaceListener<CtModuleReference> {
		private final CtCompilationUnit element;
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtCompilationUnitImportsReplaceListener implements ReplaceListListener<Collection> {
		private final CtCompilationUnit element;
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtCompilationUnitPackageDeclarationReplaceListener implements ReplaceListener<CtPackageDeclaration> {
		private final CtCompilationUnit element;
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtWildcardReferenceBoundingTypeReplaceListener implements ReplaceListener<CtTypeReference> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtAbstractSwitchCasesReplaceListener implements ReplaceListListener<List> {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtAbstractSwitchSelectorReplaceListener implements ReplaceListener<CtExpression> {
		private final CtAbstractSwitch element;
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	class CtCaseCaseExpressionsReplaceListener implements ReplaceListListener<List> {
	...
	private <K, V extends CtElement> void replaceInMapIfExist(java.util.Map<K, V> mapProtected, ReplaceMapListener listener) {
	...
	private <T extends CtElement> void replaceInSetIfExist(java.util.Set<T> setProtected, ReplaceSetListener listener) {
	...
	private <T extends CtElement> void replaceInListIfExist(java.util.List<T> listProtected, ReplaceListListener listener) {
	...
	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	@java.lang.Override
	public <A extends java.lang.annotation.Annotation> void visitCtAnnotationType(final CtAnnotationType<A> annotationType) {
	...
	public <S> void visitCtCase(final CtCase<S> caseStatement) {
		...
		replaceInListIfExist(caseStatement.getCaseExpressions(), new ReplacementVisitor.CtCaseCaseExpressionsReplaceListener(caseStatement));
	...
	public <S> void visitCtSwitch(final CtSwitch<S> switchStatement) {
		...
		replaceElementIfExist(switchStatement.getSelector(), new ReplacementVisitor.CtAbstractSwitchSelectorReplaceListener(switchStatement));
		replaceInListIfExist(switchStatement.getCases(), new ReplacementVisitor.CtAbstractSwitchCasesReplaceListener(switchStatement));
	...
	public <T, S> void visitCtSwitchExpression(final CtSwitchExpression<T, S> switchExpression) {
		replaceInListIfExist(switchExpression.getAnnotations(), new ReplacementVisitor.CtElementAnnotationsReplaceListener(switchExpression));
		replaceElementIfExist(switchExpression.getSelector(), new ReplacementVisitor.CtAbstractSwitchSelectorReplaceListener(switchExpression));
		replaceInListIfExist(switchExpression.getCases(), new ReplacementVisitor.CtAbstractSwitchCasesReplaceListener(switchExpression));
		replaceInListIfExist(switchExpression.getComments(), new ReplacementVisitor.CtElementCommentsReplaceListener(switchExpression));
		replaceElementIfExist(switchExpression.getType(), new ReplacementVisitor.CtTypedElementTypeReplaceListener(switchExpression));
		replaceInListIfExist(switchExpression.getTypeCasts(), new ReplacementVisitor.CtExpressionTypeCastsReplaceListener(switchExpression));
	}
	...
	public void visitCtWildcardReference(CtWildcardReference wildcardReference) {
		...
		replaceElementIfExist(wildcardReference.getBoundingType(), new ReplacementVisitor.CtWildcardReferenceBoundingTypeReplaceListener(wildcardReference));
	}
	...
	public void visitCtCompilationUnit(CtCompilationUnit compilationUnit) {
		replaceInListIfExist(compilationUnit.getComments(), new ReplacementVisitor.CtElementCommentsReplaceListener(compilationUnit));
		replaceInListIfExist(compilationUnit.getAnnotations(), new ReplacementVisitor.CtElementAnnotationsReplaceListener(compilationUnit));
		replaceElementIfExist(compilationUnit.getPackageDeclaration(), new ReplacementVisitor.CtCompilationUnitPackageDeclarationReplaceListener(compilationUnit));
		replaceInListIfExist(compilationUnit.getImports(), new ReplacementVisitor.CtCompilationUnitImportsReplaceListener(compilationUnit));
		replaceElementIfExist(compilationUnit.getDeclaredModuleReference(), new ReplacementVisitor.CtCompilationUnitDeclaredModuleReferenceReplaceListener(compilationUnit));
		replaceInListIfExist(compilationUnit.getDeclaredTypeReferences(), new ReplacementVisitor.CtCompilationUnitDeclaredTypeReferencesReplaceListener(compilationUnit));
	}

	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	@java.lang.Override
	public void visitCtPackageDeclaration(CtPackageDeclaration packageDeclaration) {
		replaceInListIfExist(packageDeclaration.getComments(), new ReplacementVisitor.CtElementCommentsReplaceListener(packageDeclaration));
		replaceInListIfExist(packageDeclaration.getAnnotations(), new ReplacementVisitor.CtElementAnnotationsReplaceListener(packageDeclaration));
		replaceElementIfExist(packageDeclaration.getReference(), new ReplacementVisitor.CtPackageDeclarationReferenceReplaceListener(packageDeclaration));
	}

	// auto-generated, see spoon.generating.ReplacementVisitorGenerator
	@java.lang.Override
	public void visitCtTypeMemberWildcardImportReference(CtTypeMemberWildcardImportReference wildcardReference) {
		replaceElementIfExist(wildcardReference.getTypeReference(), new ReplacementVisitor.CtTypeMemberWildcardImportReferenceTypeReferenceReplaceListener(wildcardReference));
	}
	...
	public void visitCtYieldStatement(CtYieldStatement statement) {
		replaceInListIfExist(statement.getAnnotations(), new ReplacementVisitor.CtElementAnnotationsReplaceListener(statement));
		replaceElementIfExist(statement.getExpression(), new ReplacementVisitor.CtYieldStatementExpressionReplaceListener(statement));
		replaceInListIfExist(statement.getComments(), new ReplacementVisitor.CtElementCommentsReplaceListener(statement));
	}
}
...
public class MethodTypingContext extends AbstractTypingContext {
	...
	public MethodTypingContext setMethod(CtMethod<?> method) {
		actualTypeArguments = ClassTypingContext.getTypeReferences(method.getFormalCtTypeParameters());
	...
	public MethodTypingContext setConstructor(CtConstructor<?> constructor) {
		actualTypeArguments = ClassTypingContext.getTypeReferences(constructor.getFormalCtTypeParameters());

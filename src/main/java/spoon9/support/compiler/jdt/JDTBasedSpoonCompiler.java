...
import spoon9.support.compiler.VirtualFolder;
 ...
 */
public class JDTBasedSpoonCompiler implements spoon9.SpoonModelBuilder {
	...
	protected InputStream getCompilationUnitInputStream(spoon9.reflect.cu.CompilationUnit cu) {

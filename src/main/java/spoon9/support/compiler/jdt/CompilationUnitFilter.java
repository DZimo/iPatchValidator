...
/**
 * This interface is used by instances of {@link spoon9.SpoonModelBuilder} to
 * exclude particular {@link spoon9.reflect.cu.CompilationUnit}s while
 * generating a {@link spoon9.reflect.CtModel} with
 * {@link spoon9.SpoonModelBuilder#build(spoon9.compiler.builder.JDTBuilder)}.
 *
 ...
 * {@link spoon9.reflect.CtModel} since all files will be compiled (but not
 * transformed).
 */
public interface CompilationUnitFilter {
     ...
     * {@link spoon9.reflect.CtModel} create by
     * {@link spoon9.SpoonModelBuilder#build(spoon9.compiler.builder.JDTBuilder)}.
	 *
	 * @param path

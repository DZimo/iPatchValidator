...
import spoon9.reflect.visitor.ModelConsistencyChecker;
...
import spoon9.reflect.visitor.filter.AnnotationFilter;
...
import spoon9.support.util.EmptyClearableList;
import spoon9.support.util.EmptyClearableSet;
import spoon9.support.visitor.HashcodeVisitor;
import spoon9.support.visitor.TypeReferenceScanner;
import spoon9.support.visitor.equals.CloneHelper;
import spoon9.support.visitor.equals.EqualsVisitor;
import spoon9.support.visitor.replace.ReplacementVisitor;
...
import static spoon9.reflect.visitor.CommentHelper.printComment;
...
public abstract class CtElementImpl implements CtElement {
	 ...
	 * the factory is restored in all AST nodes in {@link spoon9.support.SerializationModelStreamer}
	 */

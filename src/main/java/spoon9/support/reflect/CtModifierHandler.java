...
public class CtModifierHandler implements Serializable {
	...
	public CtModifierHandler setExtendedModifiers(Set<CtExtendedModifier> extendedModifiers) {
		if (extendedModifiers != null && !extendedModifiers.isEmpty()) {
			getFactory().getEnvironment().getModelChangeListener().onSetDeleteAll(element, CtRole.MODIFIER, this.modifiers, new HashSet<>(this.modifiers));
			...
			for (CtExtendedModifier extendedModifier : extendedModifiers) {
				getFactory().getEnvironment().getModelChangeListener().onSetAdd(element, CtRole.MODIFIER, this.modifiers, extendedModifier.getKind());
	...
	public CtModifierHandler addModifier(ModifierKind modifier) {
		...
		getFactory().getEnvironment().getModelChangeListener().onSetAdd(element, CtRole.MODIFIER, this.modifiers, modifier);
	...
	public CtModifierHandler removeModifier(ModifierKind modifier) {
		...
		getFactory().getEnvironment().getModelChangeListener().onSetDelete(element, CtRole.MODIFIER, modifiers, modifier);

...
public class CtConditionalImpl<T> extends CtExpressionImpl<T> implements CtConditional<T> {
	...
	public <C extends CtConditional<T>> C setElseExpression(CtExpression<T> elseExpression) {
		...
		getFactory().getEnvironment().getModelChangeListener().onObjectUpdate(this, CtRole.ELSE, elseExpression, this.elseExpression);
	...
	public <C extends CtConditional<T>> C setCondition(CtExpression<Boolean> condition) {
		...
		getFactory().getEnvironment().getModelChangeListener().onObjectUpdate(this, CtRole.CONDITION, condition, this.condition);
	...
	public <C extends CtConditional<T>> C setThenExpression(CtExpression<T> thenExpression) {
		...
		getFactory().getEnvironment().getModelChangeListener().onObjectUpdate(this, CtRole.THEN, thenExpression, this.thenExpression);

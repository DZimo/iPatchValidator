...
public class CtIfImpl extends CtStatementImpl implements CtIf {
	...
	public <T extends CtIf> T setElseStatement(CtStatement elseStatement) {
		...
		getFactory().getEnvironment().getModelChangeListener().onObjectUpdate(this, CtRole.ELSE, elseStatement, this.elseStatement);
	...
	public <T extends CtIf> T setThenStatement(CtStatement thenStatement) {
		...
		getFactory().getEnvironment().getModelChangeListener().onObjectUpdate(this, CtRole.THEN, thenStatement, this.thenStatement);

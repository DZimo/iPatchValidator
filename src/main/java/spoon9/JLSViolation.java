...
/**
 * This exception is thrown when an operation on a {@link spoon9.reflect.declaration.CtElement} transfers it in an invalid state.
 * <p>
 * An invalid state is a state that is not conform to the JLS. For example, a {@link spoon9.reflect.declaration.CtMethod} is in an invalid state if it is abstract and has a body.
 */

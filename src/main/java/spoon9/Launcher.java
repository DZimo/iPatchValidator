...
import spoon9.support.compiler.VirtualFile;
import spoon9.support.compiler.jdt.JDTBasedSpoonCompiler;
import spoon9.support.gui.SpoonModelTree;
...
public class Launcher implements SpoonAPI {
	...
	private String getVersionMessage() {
		return "Spoon version " + ResourceBundle.getBundle("spoon9").getString("application.version");
	}

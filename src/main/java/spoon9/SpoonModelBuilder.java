...
import spoon9.support.compiler.jdt.CompilationUnitFilter;
import spoon9.support.compiler.jdt.FactoryCompilerConfig;
import spoon9.support.compiler.jdt.FileCompilerConfig;
import spoon9.support.compiler.jdt.JDTBatchCompiler;
...
public interface SpoonModelBuilder {
	 ...
	 * CTTYPES - compiles virtual java files, which are dynamically generated from the all top level classes of the CtModel by {@link spoon9.reflect.visitor.DefaultJavaPrettyPrinter}
	 */
	interface InputType {

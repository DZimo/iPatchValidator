 ...
 * accessible through {@link Factory#getEnvironment()}. Its
...
public interface Environment {
	 ...
	 * - parents are consistent (see {@link AstParentConsistencyChecker})
	 * - hashcode violation (see {@link CtElementImpl#equals(Object)})
	 * - method violation (see {@link CtType#addMethod(CtMethod)})
	 * are active or not.
	 *
	...
	enum PRETTY_PRINTING_MODE {
		/** direct in {@link DefaultJavaPrettyPrinter}, no preprocessors are applied to the model before pretty-printing }. */
		DEBUG,

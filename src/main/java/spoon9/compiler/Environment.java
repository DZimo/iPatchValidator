 ...
 * accessible through {@link spoon9.reflect.factory.Factory#getEnvironment()}. Its
...
public interface Environment {
	 ...
	 * - parents are consistent (see {@link spoon9.reflect.visitor.AstParentConsistencyChecker})
	 * - hashcode violation (see {@link spoon9.support.reflect.declaration.CtElementImpl#equals(Object)})
	 * - method violation (see {@link spoon9.reflect.declaration.CtType#addMethod(CtMethod)})
	 * are active or not.
	 *
	...
	enum PRETTY_PRINTING_MODE {
		/** direct in {@link spoon9.reflect.visitor.DefaultJavaPrettyPrinter}, no preprocessors are applied to the model before pretty-printing }. */
		DEBUG,

 ...
 * {@link spoon9.reflect.factory.Factory} with a set of processors. The program model has
 * been previously built using a {@link spoon9.SpoonModelBuilder} - see
 * {@link spoon9.SpoonModelBuilder#build()}. To use, add processors to
 * the manager, and then call the {@code process} method. Also, the method
 * {@link Processor#processingDone()} is up called.
 *
 * @see spoon9.compiler.Environment#getManager()
 */

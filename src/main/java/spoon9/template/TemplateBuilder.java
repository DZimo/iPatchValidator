 ...
 */
package spoon9.template;


import spoon9.SpoonException;
import spoon9.pattern.Pattern;
import spoon9.pattern.PatternBuilderHelper;
...
import spoon9.support.template.Parameters;
...
class TemplateBuilder {
	...
	private static class PatternBuilder extends spoon9.pattern.PatternBuilder {
	...
	public Map<String, Object> getTemplateParameters(CtType<?> targetType) {
		...
		if (targetType != null) {
			templateParametersAsMap.put(spoon9.pattern.PatternBuilder.TARGET_TYPE, targetType.getReference());
		}

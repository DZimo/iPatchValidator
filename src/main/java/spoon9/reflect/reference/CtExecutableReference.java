 ...
 * {@link spoon9.reflect.declaration.CtMethod} or a
 * {@link spoon9.reflect.declaration.CtConstructor}.
 */
public interface CtExecutableReference<T> extends CtReference, CtActualTypeContainer {
	...
	/**
	 * Gets the signature of this method or constructor, as explained in {@link spoon9.reflect.declaration.CtMethod#getSignature()}.
	 */
	String getSignature();

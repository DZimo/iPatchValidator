...
public class CtBiScannerDefault extends CtAbstractBiScanner {
	protected java.util.Deque<CtElement> stack = new java.util.ArrayDeque<>();
	...
	protected void biScan(CtRole role, java.util.Collection<? extends CtElement> elements, java.util.Collection<? extends CtElement> others) {
		for (java.util.Iterator<? extends CtElement> firstIt = elements.iterator(), secondIt = others.iterator(); firstIt.hasNext() && secondIt.hasNext();) {
	...
	public <S> void visitCtCase(final CtCase<S> caseStatement) {
		...
		biScan(CtRole.EXPRESSION, caseStatement.getCaseExpressions(), other.getCaseExpressions());
	...
	public void visitCtTextBlock(final CtTextBlock literal) {
		CtTextBlock other = ((CtTextBlock) (this.stack.peek()));
		enter(literal);
		biScan(CtRole.ANNOTATION, literal.getAnnotations(), other.getAnnotations());
		biScan(CtRole.TYPE, literal.getType(), other.getType());
		biScan(CtRole.CAST, literal.getTypeCasts(), other.getTypeCasts());
	...
	public <T, S> void visitCtSwitchExpression(final CtSwitchExpression<T, S> switchExpression) {
		...
		biScan(CtRole.ANNOTATION, switchExpression.getAnnotations(), other.getAnnotations());
		biScan(CtRole.EXPRESSION, switchExpression.getSelector(), other.getSelector());
		biScan(CtRole.CASE, switchExpression.getCases(), other.getCases());
		biScan(CtRole.COMMENT, switchExpression.getComments(), other.getComments());
		biScan(CtRole.TYPE, switchExpression.getType(), other.getType());
		biScan(CtRole.CAST, switchExpression.getTypeCasts(), other.getTypeCasts());
	...
	public void visitCtCompilationUnit(CtCompilationUnit compilationUnit) {
		...
		biScan(CtRole.COMMENT, compilationUnit.getComments(), other.getComments());
		biScan(CtRole.ANNOTATION, compilationUnit.getAnnotations(), other.getAnnotations());
		biScan(CtRole.PACKAGE_DECLARATION, compilationUnit.getPackageDeclaration(), other.getPackageDeclaration());
		biScan(CtRole.DECLARED_IMPORT, compilationUnit.getImports(), other.getImports());
		biScan(CtRole.DECLARED_MODULE_REF, compilationUnit.getDeclaredModuleReference(), other.getDeclaredModuleReference());
		biScan(CtRole.DECLARED_TYPE_REF, compilationUnit.getDeclaredTypeReferences(), other.getDeclaredTypeReferences());
	...
	public void visitCtPackageDeclaration(CtPackageDeclaration packageDeclaration) {
		...
		biScan(CtRole.COMMENT, packageDeclaration.getComments(), other.getComments());
		biScan(CtRole.ANNOTATION, packageDeclaration.getAnnotations(), other.getAnnotations());
		biScan(CtRole.PACKAGE_REF, packageDeclaration.getReference(), other.getReference());
	...
	public void visitCtTypeMemberWildcardImportReference(CtTypeMemberWildcardImportReference wildcardReference) {
		...
		enter(wildcardReference);
		biScan(CtRole.TYPE_REF, wildcardReference.getTypeReference(), other.getTypeReference());
		exit(wildcardReference);
	}
	...
	public void visitCtYieldStatement(CtYieldStatement statement) {
		...
		enter(statement);
		biScan(CtRole.ANNOTATION, statement.getAnnotations(), other.getAnnotations());
		biScan(CtRole.EXPRESSION, statement.getExpression(), other.getExpression());
		biScan(CtRole.COMMENT, statement.getComments(), other.getComments());
		exit(statement);
	}
}

 ...
 * reference through a {@link CtScanner}-based deep
 * search. It uses the {@link Filter} facility to select the right
...
public abstract class Query {
	 ...
	 * Use {@link spoon9.reflect.visitor.chain.CtQueryable#map(CtFunction)} if you need more control on the scanning context of the Filter.
	 *
	 * @param <E>
	 * 		the type of the sought program elements
	 * @param rootElement

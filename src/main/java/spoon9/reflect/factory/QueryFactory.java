...
import spoon9.reflect.visitor.chain.CtQueryImpl;
...
public class QueryFactory extends SubFactory {
	 ...
	 * before {@link CtQuery#forEach(spoon9.reflect.visitor.chain.CtConsumer)}
	 ...
	 * {@link CtQuery#forEach(spoon9.reflect.visitor.chain.CtConsumer)}

 ...
 * The programmers should instantiate or resolve the meta-elements by using {@link spoon9.reflect.factory.Factory}'s sub-factories because it ensures
 * the model consistency. The {@link spoon9.reflect.factory.CoreFactory} is the raw factory for program elements and is the

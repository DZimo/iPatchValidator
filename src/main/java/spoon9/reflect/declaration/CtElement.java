...
import spoon9.reflect.visitor.CtVisitable;
...
public interface CtElement extends FactoryAccessor, CtVisitable, Cloneable, CtQueryable, Serializable, SourcePositionHolder {
	 ...
	 *
	 * See also {@link #getComments()}.and {@link spoon9.reflect.code.CtJavaDoc}
	 */
	@DerivedProperty
	 ...
	 * In this case, consider using methods {@link spoon9.refactoring.Refactoring#copyType(CtType)} and {@link spoon9.refactoring.Refactoring#copyMethod(CtMethod)} instead which does additional work beyond cloning.
	 */
	CtElement clone();
	 ...
	 *
	 * See {@link spoon9.reflect.meta.impl.RoleHandlerHelper} for more advanced methods.
	 */
	 ...
	 * Warning: this is not side-effect free, this triggers some {@link spoon9.reflect.visitor.ImportAnalyzer} which would change the model: add/remove imports, change the value `implicit` of some model elements, etc.
	 */
	@Experimental
	String prettyprint();

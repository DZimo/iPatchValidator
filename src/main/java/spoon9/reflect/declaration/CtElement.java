...
import spoon9.reflect.visitor.ImportAnalyzer;
...
public interface CtElement extends FactoryAccessor, CtVisitable, Cloneable, CtQueryable, Serializable, SourcePositionHolder {
	 ...
	 *
	 * See also {@link #getComments()}.and {@link CtJavaDoc}
	 */
	@DerivedProperty
	 ...
	 * In this case, consider using methods {@link Refactoring#copyType(CtType)} and {@link Refactoring#copyMethod(CtMethod)} instead which does additional work beyond cloning.
	 */
	CtElement clone();
	 ...
	 *
	 * See {@link RoleHandlerHelper} for more advanced methods.
	 */
	 ...
	 * Warning: this is not side-effect free, this triggers some {@link ImportAnalyzer} which would change the model: add/remove imports, change the value `implicit` of some model elements, etc.
	 */
	@Experimental
	String prettyprint();
